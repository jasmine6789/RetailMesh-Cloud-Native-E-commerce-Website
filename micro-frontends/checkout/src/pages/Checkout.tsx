...
export default function Checkout(props: CheckoutProps) {
  ...
  function handlePlaceOrder() {
    ...
    if (paymentMethod === 1) {
      ...
      if (cardError) {
        message.warning(cardError);
        return;
      }
    }

    const nameParts = shippingInfo.fullName.trim().split(/\s+/);
    ...
    checkout(
      {
        ...
        firstName,
        lastName,
        emailAddress: getUserEmail(user) || 'demo@retailmesh.com',
        ...
        cardName: paymentMethod === 1 ? cardDetails.cardName : 'N/A',
        cardNumber:
          paymentMethod === 1
            ? cardDetails.cardNumber.replace(/\s/g, '')
            : '0000000000000000',
        expiration: paymentMethod === 1 ? cardDetails.expiration : 'N/A',
        cvv: paymentMethod === 1 ? cardDetails.cvv : '000',
