# RetailMesh Micro-Frontends

React 18+ storefront shell and remotes (Module Federation + Nx monorepo).
...
- **auth-provider** - JWT authentication provider (Identity.API)
...
cd RetailMesh-Cloud-Native-E-commerce-Website/micro-frontends
