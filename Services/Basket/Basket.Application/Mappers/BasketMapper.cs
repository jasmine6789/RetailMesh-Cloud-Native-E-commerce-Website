...
public partial class BasketMapper
{
    ...
    public partial BasketCheckoutItemEvent ToBasketCheckoutItemEvent(ShoppingCartItem item);
    public partial BasketCheckoutItemEvent ToBasketCheckoutItemEvent(ShoppingCartItemResponse item);
}
