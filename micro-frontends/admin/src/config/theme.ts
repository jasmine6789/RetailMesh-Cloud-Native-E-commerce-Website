...
export const adminThemeConfig: ThemeConfig = {
  token: {
    ...
    colorPrimary: '#33a1ff',
    colorPrimaryHover: '#5cb3ff',
    colorPrimaryActive: '#1a8fe6',
    ...
    boxShadowSecondary: '0 4px 16px rgba(51, 161, 255, 0.25)',
  ...
  components: {
    ...
    Button: {
      ...
      paddingInline: 16,
      fontWeight: 600,
      primaryShadow: '0 2px 8px rgba(51, 161, 255, 0.3)',
    },
    Input: {
      controlHeight: 36,
      controlHeightSM: 28,
