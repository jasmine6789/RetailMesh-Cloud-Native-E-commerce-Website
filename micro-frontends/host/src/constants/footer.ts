...
export const FOOTER_SOCIAL_LINKS: SocialLink[] = [
  {
    name: 'facebook',
    url: 'https://facebook.com/retailmesh',
    ariaLabel: 'Visit us on Facebook',
  },
  {
    name: 'instagram',
    url: 'https://instagram.com/retailmesh',
    ariaLabel: 'Follow us on Instagram',
  },
  {
    name: 'twitter',
    url: 'https://twitter.com/retailmesh',
    ariaLabel: 'Follow us on Twitter',
  },
  {
    name: 'linkedin',
    url: 'https://linkedin.com/company/retailmesh',
...
export const FOOTER_BRAND = {
  ...
  copyright: '© 2025 RetailMesh. All rights reserved.',
} as const;
