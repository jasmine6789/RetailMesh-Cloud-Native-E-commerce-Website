 ...
 * Uses auth-provider for the authenticated user (Identity.API JWT)
 *
 ...
 * Profile updates are not implemented on the backend yet.
 *
...
export async function updateUserProfile(
  ...
  console.warn(
    ...
    'Profile updates are not supported by the API yet.',
    request.payload
  );
