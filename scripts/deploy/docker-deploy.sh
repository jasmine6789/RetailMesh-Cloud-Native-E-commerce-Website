...
initialize_localstack_s3() {
    ...
    if bash scripts/init-localstack-s3.sh ecommerce-product-images http://localhost:4566 assets/product-images; then
        ...
        log_info "Manual command: bash scripts/init-localstack-s3.sh ecommerce-product-images http://localhost:4566 assets/product-images"
    fi
